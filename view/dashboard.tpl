    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">{$VFAT}</span>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">R$ {$VMES}</span>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">R$ {$VANO}</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-3 col-xs-6">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">{$RANO}</span>
            </div>
        </div>
    </div>
    <div class="col-sm-3 col-xs-6">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">{$RMES}</span>
            </div>
        </div>
    </div>
    <div class="col-sm-3 col-xs-6">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">{$LANO}</span>
            </div>
        </div>
    </div>
    <div class="col-sm-3 col-xs-6">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number total_purchase">{$LMES}</span>
            </div>
        </div>
    </div>
</div>
