...
class Conexao extends Config {
    ...
    function ExecuteSQL($query, array $params = NULL) {
        ...
        return $this->obj->execute();         //or die(implode($pdo->errorInfo()))
    }
    /**
    *
    * @return array com os dados da SQL
    */
    ...
    protected function Paginacao($pagina = array()) {
        ...
        $pag .= '<li><a href="?p=1"><span>«</span></a></li>';
        ...
        $pag .= '<li><a href="?p=' . $this->totalpags . '"><span>»</span></a></li>';
        $pag .= '</ul>';
